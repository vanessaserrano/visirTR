...
pckgs<-c("shiny","shinyjs","shinythemes", "shinydashboard",
         "knitr","rmarkdown",
         "tidyverse", "ggthemes", "ggrepel",
         "XML","DT","gplots",
         "xts","dygraphs","scales",
...
There are `r ncol(dfEvMilestones_xUser_ext) - 2` evaluation milestones in **`r ifelse(emExist,emFileName_ext,"")`**: <br /> `r paste(colnames(dfEvMilestones_xUser_ext[,-c(1,ncol(dfEvMilestones_xUser_ext))]), sep="; ")`.

``` {r, echo=F, include = T, results="asis"}
cat(ifelse(!emExist, "-->", "<!--"))
```

Evaluation milestones are not loaded and observation milestones will be used instead.
